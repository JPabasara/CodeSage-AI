...
```powershell
kubectl apply -f infra/k8s/linode/namespace.yaml
kubectl apply -f infra/k8s/linode/configmap.yaml
kubectl create secret generic codesage-secrets `
  --namespace codesageai `
  --from-env-file infra/k8s/linode/secrets.prod.env
kubectl apply -f infra/k8s/linode/ml.yaml
kubectl apply -f infra/k8s/linode/migrate-job.yaml
kubectl apply -f infra/k8s/linode/api.yaml
kubectl apply -f infra/k8s/linode/worker.yaml
kubectl apply -f infra/k8s/linode/score-worker.yaml
kubectl apply -f infra/k8s/linode/web.yaml
kubectl apply -f infra/k8s/linode/ingress.yaml
kubectl apply -f infra/k8s/linode/keda-worker.yaml
kubectl apply -f infra/k8s/linode/keda-score-worker.yaml
```
